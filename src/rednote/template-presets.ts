...
export const REDNOTE_TEMPLATE_PRESETS: Record<string, RedNoteTemplatePreset> = {
  ...
  'pure-blue': createMinimalTemplate(
    'pure-blue',
    '纯净蓝',
    '正文卡片流的纯白无框版，蓝色标题与淡蓝重点标记',
    {
      '--rn-frame-bg': '#ffffff',
      '--rn-frame-border': 'transparent',
      '--rn-frame-shadow': 'none',
      '--rn-panel-bg': '#ffffff',
      '--rn-avatar-bg': '#eff6ff',
      '--rn-avatar-color': '#2563eb',
      '--rn-name-color': '#0f172a',
      '--rn-body-color': '#263244',
      '--rn-heading-color': '#2563eb',
      '--rn-emphasis-color': '#263244',
      '--rn-emphasis-bg': 'transparent',
      '--rn-link-color': '#2563eb',
      '--rn-link-border': 'rgba(37, 99, 235, 0.28)',
      '--rn-quote-bg': '#f8fbff',
      '--rn-quote-border': 'rgba(37, 99, 235, 0.16)',
      '--rn-code-bg': '#f5f8fc',
      '--rn-code-color': '#1d4ed8',
      '--rn-table-border': 'rgba(37, 99, 235, 0.16)',
      '--rn-table-header-bg': '#eff6ff',
      '--rn-footer-bg': 'transparent',
      '--rn-footer-border': 'transparent',
    }
  ),
